...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2348084644182";
...
module.exports = {
  ...
  caption : global.caption || "Ͳհҽ օղҽ ąҍօѵҽ ąӀӀ 👑🌍☠️" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  ...
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "HRKU-b2e4fbe3-c9a6-41ee-ad72-2ada0b4646c8",
